...
function WebsitesDesigns() {
  ...
  const projects = [
    ...
    },
    {
      ...
      image:
        "/placeholder.svg?height=400&width=600&text=Portfolio+Dashboard",
          ...
          <AnimatePresence mode="wait">
            {filteredProjects.map((project) => (
              <motion.div
                ...
                exit="exit"
                layout
                className={`group relative bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 ${
